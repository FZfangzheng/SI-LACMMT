...
class MYDATAPARISDataset(Pix2pixDataset):
    ...
    def get_paths(self, opt):
        # croot = r'/data3/fangzheng/map_generator/experiment/liangshuaizhe/about_Paris18/use_4900_norepaint/use'
        croot = r'/data/fine_grained_multimap/dataset/liangshuaizhe/about_Paris18/use_4900_norepaint/use'
