...
class MYDATADataset(Pix2pixDataset):
    ...
    def get_paths(self, opt):
        croot = r'/data3/fangzheng/map_generator/experiment/US/US_dataset_downsample_v2'
        # croot = r'/data/multimap_data/6_15_experiment/TSIT-master/datasets/mydata'
        # croot = r'/BIT/BIT/fangzheng/data/data_for_SPADE_SH'
