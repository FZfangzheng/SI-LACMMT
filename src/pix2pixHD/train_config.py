...
def config():
    ...
    parser.add_argument('--pca_swin_select', type=int, default=0, help='mutil_layer, 0 is not ')
    ...
    parser.add_argument('--start_train_C_epoch', type=int, default=20, help='gardloss_alpha.')
    ...
    parser.add_argument('--C_lr', type=float, default=0.0001, help='The Learning Rate of discriminator.')
    ...
    parser.add_argument('--result', '-r', type=str, default=None, help='Folder to save checkpoints.')
    ...
    parser.add_argument('--netD', type=str, default='originD',help='selects model to use for netG')
    ...
    parser.add_argument('--lambda_feat_vgg', type=float, default=10.0, help='weight for feature matching loss')
    parser.add_argument('--lambda_feat_df', type=float, default=10.0, help='weight for feature matching loss')
    parser.add_argument('--lambda_feat_ll', type=float, default=10.0, help='weight for feature matching loss')
    parser.add_argument('--lambda_feat', type=float, default=10.0, help='weight for feature matching loss')
    parser.add_argument('--lambda_c_d', type=float, default=1, help='weight for feature matching loss')
    ...
    # for starganv2
    # parser.add_argument('--mapping_network_lr', type=float, default=1e-6, help='Learning rate for mapping_network')
    # parser.add_argument('--style_encoder——', type=float, default=1e-4, help='Learning rate for mapping_network')
    parser.add_argument('--map_style_weight_decay', type=float, default=1e-4, help='Weight decay for optimizer')
    ...
    parser.add_argument('--style_encoder_lr', type=float, default=1e-4,
                        help='Learning rate for style_encoder_lr')
    parser.add_argument('--mapping_network_lr', type=float, default=1e-6,
                        help='Learning rate for mapping_network')

    parser.add_argument('--use_style_rec_loss', default=1, type=int,
                        help='if true, use use_diversity_sens_loss')

    parser.add_argument('--use_diversity_sens_loss', default=1, type=int,
                        help='if true, use use_diversity_sens_loss')

    parser.add_argument('--lambda_style', type=float, default=1.0, help='weight for feature matching loss')
    parser.add_argument('--lambda_dsl', type=float, default=1.0, help='weight for feature matching loss')
