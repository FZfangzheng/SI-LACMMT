...
class deeplabv3plus(nn.Module):
    def __init__(self, cfg):
        ...
        self.upsample4=nn.Sequential(
            nn.ConvTranspose2d(cfg.MODEL_NUM_CLASSES, cfg.MODEL_NUM_CLASSES, kernel_size=3, stride=2,padding=1,output_padding=1),
            SynchronizedBatchNorm2d(cfg.MODEL_NUM_CLASSES, momentum=cfg.TRAIN_BN_MOM),
            nn.ReLU(inplace=True),
            nn.Dropout(0.5),
            nn.ConvTranspose2d(cfg.MODEL_NUM_CLASSES, cfg.MODEL_NUM_CLASSES, kernel_size=3, stride=2, padding=1,
                               output_padding=1),
            SynchronizedBatchNorm2d(cfg.MODEL_NUM_CLASSES, momentum=cfg.TRAIN_BN_MOM),
            nn.ReLU(inplace=True),
            nn.Dropout(0.5)
        ...
        self.upsample_sub=nn.Sequential(
            nn.ConvTranspose2d(cfg.MODEL_ASPP_OUTDIM, cfg.MODEL_ASPP_OUTDIM, kernel_size=3, stride=2,padding=1,output_padding=1),
            SynchronizedBatchNorm2d(cfg.MODEL_ASPP_OUTDIM, momentum=cfg.TRAIN_BN_MOM),
            nn.ReLU(inplace=True),
            nn.Dropout(0.5),
            nn.ConvTranspose2d(cfg.MODEL_ASPP_OUTDIM, cfg.MODEL_ASPP_OUTDIM, kernel_size=3, stride=2, padding=1,
                               output_padding=1),
            SynchronizedBatchNorm2d(cfg.MODEL_ASPP_OUTDIM, momentum=cfg.TRAIN_BN_MOM),
            nn.ReLU(inplace=True),
            nn.Dropout(0.5)
